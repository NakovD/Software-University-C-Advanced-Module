namespace _03BarracksFactory.Data
{
    ...
    class UnitRepository : IRepository
    {
        ...
        {
            if (!this.amountOfUnits.ContainsKey(unitType)) throw new ArgumentException("No such units in repository.");

            if (this.amountOfUnits[unitType] <= 0) throw new ArgumentException("No such units in repository.");
