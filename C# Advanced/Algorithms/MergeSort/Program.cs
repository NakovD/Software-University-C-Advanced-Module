...
namespace MergeSort
{
    internal class Program
    {
        ...
        {
            var arrayUnsorted = Console.ReadLine().Split(" ", StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray();

            var sortedArray = MergeSorter.MergeSort(arrayUnsorted);
